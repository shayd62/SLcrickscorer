        ...
        const fetchTeam = async () => {
            ...
            if (docSnap.exists()) {
                ...
                form.reset({
                    ...
                    isPinProtected: teamData.isPinProtected,
                          ...
                          <div className="flex items-center justify-between px-4 py-3">
                            ...
                            <div className="px-4 py-3">
                             ...
                             <div className="flex items-center justify-between px-4 py-3">
                                ...
                                <Switch id="pin-protected" checked={form.watch('isPinProtected')} onCheckedChange={(checked) => form.setValue('isPinProtected', checked)} />
                            </div>
                    </div>
                </CardContent>
            </Card>
...
export default EditTeamFormPage;
